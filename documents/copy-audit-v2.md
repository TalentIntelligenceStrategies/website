...
> **Split note (2026-06-08)** — the 4 dense cards were streamlined into **6 lean cards**, one idea each, with no new claims or numbers. Card 2 (institutional) split into *Joint license* + *Patent-troll defense*; card 3 (DLC) split into *Active next day* + *Verify & display*. Two short ZH titles were minted from existing body text and need Irene sign-off (flagged `❓` below): `主動式防護盾` (Deliv 3) and `2 秒驗證，自由展示` (Deliv 5). Discount stays `88 折 / up to 12%` per shipped HTML — note the `licensing-page-prd.md` FAQ Q4 `24 個月最高省 15%` discrepancy, not resolved here.

| Element | ZH | ZH Status | Literal EN | EN | EN Status | Shipped |
|---|---|---|---|---|---|---|
| Card Title (Deliv 1) | AI 智慧雷達導航 | ⚪ | AI smart-radar navigation | AI does the search — you get a curated 30-patent bundle | ⚪ | 🟡 |
| Card Body (Deliv 1) | 依出口國 × 產業別 × 產品線三軸掃描風險缺口，5 分鐘內推薦最相關的 30 件專利。支援人機協作與手動替換，不需懂法律。 | ⚪ | Scans risk gaps across three axes — export country × industry × product line — and recommends the 30 most relevant patents within 5 minutes. Human-AI collaboration + manual swap supported; no legal expertise needed. | Scans risk gaps across export country × industry × product line and recommends the 30 most relevant patents in 5 minutes. Manual swap supported; no legal expertise required. | ⚪ | 🟡 |
| Card Title (Deliv 2) | 權威法人聯合授權 | ⚪ | Authoritative institutional joint license | Joint license in your name — non-exclusive, fully legal | ⚪ | 🟡 |
| Card Body (Deliv 2) | 創智、資策會、陽明交大以貴公司名義開立 30 件合法非獨家專利。在國際買家與投資人面前，是機構級 IP 後盾，撕掉「代工小廠」的標籤。 | ⚪ | ITRI, III and NYCU issue 30 legal non-exclusive patents in your company's name. In front of international buyers and investors, it's institution-grade IP backing that strips the "small OEM" label. | ITRI, III and NYCU issue 30 legal, non-exclusive patents directly in your company's name — institution-level IP backing buyers and investors recognize, not a "small OEM" label. | ⚪ | 🟡 |
| Card Title (Deliv 3) | 主動式防護盾 | ❓ | Proactive protection shield | Patent-troll defense — passive to active | ⚪ | 🟡 |
| Card Body (Deliv 3) | 專利流氓（NPE）只挑好下手的目標。三家機構的合法 IP 防線拉高攻擊成本，他們自然跳過你。從被動防禦轉為主動佈局。 | ⚪ | Patent trolls (NPEs) only pick easy targets. Three institutions' legal IP defense line raises attack cost, so they skip you. Shift from passive defense to active positioning. | Patent trolls (NPEs) pick easy targets. Three institutions' legal IP line raises the cost of attack — so they skip you. Passive defense becomes active position. | ⚪ | 🟡 |
| Card Title (Deliv 4) | 付款隔日立即生效 | ⚪ | Active the day after payment | Active the day after payment — DLC + co-branded badge | ⚪ | 🟡 |
| Card Body (Deliv 4) | 金流確認隔日防護網生效。交付含公證電子簽章的數位授權憑證（DLC），以及「TIS × 權威機構」聯名授權認證標章。 | ⚪ | The day after payment confirms, the shield activates. Delivers a Digital License Credential (DLC) with a notarized e-signature, plus a "TIS × institution" co-branded license badge. | Payment confirmed, protection goes live the next day. You receive a Digital License Credential (DLC) with a notarized e-signature and a co-branded "TIS × institution" badge. | ⚪ | 🟡 |
| Card Title (Deliv 5) | 2 秒驗證，自由展示 | ❓ | Verify in 2 seconds, display freely | Verify in 2 seconds, display anywhere | ⚪ | 🟡 |
| Card Body (Deliv 5) | 標章內嵌獨一授權編號與 QR Code，2 秒線上即時驗證。可印於國際展位、提案書、官網 Footer 或產品外包裝。 | ⚪ | The badge embeds a unique license number and QR code, verified online in 2 seconds. Printable on international booths, proposals, website footer, or product packaging. | The badge carries a unique license number and QR code — verified online in 2 seconds. Print it on booth signage, proposals, your website footer, or product packaging. | ⚪ | 🟡 |
| Card Title (Deliv 6) | 專利轉化為 OpEx 租賃保險 | ⚪ | Convert patents to OpEx lease insurance | Patent licensing as OpEx — under NT$10K/month, flexible terms | ⚪ | 🟡 |
| Card Body (Deliv 6) | 自行申請 1 件專利需 NT$50,000+ 與 18 個月；專職 IP 工程師年成本破百萬。訂閱讓月均不到 1 萬，3 / 6 / 12 / 24 個月彈性期別，2 年方案最高 88 折。 | ⚪ | Filing 1 patent yourself takes NT$50,000+ and 18 months; a dedicated IP engineer costs over NT$1M a year. A subscription keeps the monthly average under NT$10K — 3 / 6 / 12 / 24-month flexible terms, 2-year plans up to 12% off. | Filing one patent yourself runs NT$50,000+ and 18 months; an in-house IP engineer breaks NT$1M a year. A subscription keeps you under NT$10K/month — flexible 3/6/12/24-month terms, up to 12% off on 2-year plans. | ⚪ | 🟡 |
